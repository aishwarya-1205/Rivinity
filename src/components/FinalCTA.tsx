...
const FinalCTA = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-[850px] flex flex-col items-center justify-center bg-white dark:bg-slate-950 py-32 lg:py-40"
    >
      {/* Backgrounds */}
      <NeuralSphere />
        ...
        >
          ...
          <motion.div variants={wordVariants} className="mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-900/5 dark:bg-white/10 border border-slate-200 dark:border-white/20 backdrop-blur-md">
              ...
              <span className="text-xs font-semibold text-slate-600 dark:text-slate-200 tracking-wider uppercase">
                Limitless Potential
              </span>
            </div>
          </motion.div>
          ...
          <h2 className="text-4xl md:text-9xl font-display font-bold text-slate-900 dark:text-white mb-8 tracking-tighter leading-[0.9]">
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-2">
              {["Start", "Your", "Evolution"].map((word, i) => (
                <motion.span
                  ...
                  className={
                    i === 2
                      ? "text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-violet-600 to-pink-500"
                      : ""
                  }
                >
                  {word}
          ...
          <motion.p
            variants={wordVariants}
            className="text-xl md:text-2xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto mb-16 leading-relaxed"
          >
